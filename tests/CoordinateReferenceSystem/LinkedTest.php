...
use Dmandrade\GeoJson\CoordinateReferenceSystem\Linked;
...
class LinkedTest extends \PHPUnit_Framework_TestCase
{
    public function testIsSubclassOfCoordinateReferenceSystem()
    {
        $this->assertTrue(is_subclass_of(
            'Dmandrade\GeoJson\CoordinateReferenceSystem\Linked',
            'Dmandrade\GeoJson\CoordinateReferenceSystem\CoordinateReferenceSystem'
        ));
    }
...
JSON;
        ...
        $this->assertInstanceOf('Dmandrade\GeoJson\CoordinateReferenceSystem\Linked', $crs);
        $this->assertSame('link', $crs->getType());
