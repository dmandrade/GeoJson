...
abstract class BaseGeoJsonTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMockBuilder('Dmandrade\GeoJson\BoundingBox')
    ...
    {
        return $this->getMockBuilder('Dmandrade\GeoJson\CoordinateReferenceSystem\CoordinateReferenceSystem')
            ->disableOriginalConstructor()
            ->getMock();
    }
    ...
    {
        return $this->getMockBuilder('Dmandrade\GeoJson\Feature\Feature')
            ->disableOriginalConstructor()
            ->getMock();
    }
    ...
    {
        return $this->getMockBuilder('Dmandrade\GeoJson\Geometry\Geometry')
            ->disableOriginalConstructor()
            ->getMock();
    }
}
