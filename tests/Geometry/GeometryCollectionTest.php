...
use Dmandrade\GeoJson\Geometry\GeometryCollection;
...
class GeometryCollectionTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Geometry\GeometryCollection');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Geometry\GeometryCollection', 'Dmandrade\GeoJson\Geometry\Geometry'));
    }
...
JSON;
        ...
        $this->assertInstanceOf('Dmandrade\GeoJson\Geometry\GeometryCollection', $collection);
        $this->assertSame('GeometryCollection', $collection->getType());
