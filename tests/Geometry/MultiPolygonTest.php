...
use Dmandrade\GeoJson\Geometry\MultiPolygon;
use Dmandrade\GeoJson\Geometry\Polygon;
...
class MultiPolygonTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Geometry\MultiPolygon');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Geometry\MultiPolygon', 'Dmandrade\GeoJson\Geometry\Geometry'));
    }
...
JSON;
        ...
        $this->assertInstanceOf('Dmandrade\GeoJson\Geometry\MultiPolygon', $multiPolygon);
        $this->assertSame('MultiPolygon', $multiPolygon->getType());
