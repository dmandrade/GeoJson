...
class PointTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Geometry\Point');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Geometry\Point', 'Dmandrade\GeoJson\Geometry\Geometry'));
    }
