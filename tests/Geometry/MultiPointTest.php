...
use Dmandrade\GeoJson\Geometry\MultiPoint;
use Dmandrade\GeoJson\Geometry\Point;
...
class MultiPointTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Geometry\MultiPoint');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Geometry\MultiPoint', 'Dmandrade\GeoJson\Geometry\Geometry'));
    }
...
JSON;
        ...
        $this->assertInstanceOf('Dmandrade\GeoJson\Geometry\MultiPoint', $multiPoint);
        $this->assertSame('MultiPoint', $multiPoint->getType());
