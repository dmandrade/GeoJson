...
class LinearRingTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Geometry\LinearRing');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Geometry\LinearRing', 'Dmandrade\GeoJson\Geometry\LineString'));
    }
