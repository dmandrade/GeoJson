...
class LineStringTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Geometry\LineString');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Geometry\LineString', 'Dmandrade\GeoJson\Geometry\MultiPoint'));
    }
...
JSON;
        ...
        $this->assertInstanceOf('Dmandrade\GeoJson\Geometry\LineString', $lineString);
        $this->assertSame('LineString', $lineString->getType());
