...
use Dmandrade\GeoJson\Feature\FeatureCollection;
...
class FeatureCollectionTest extends BaseGeoJsonTest
{
    ...
    {
        $class = new \ReflectionClass('Dmandrade\GeoJson\Feature\FeatureCollection');
    ...
    {
        $this->assertTrue(is_subclass_of('Dmandrade\GeoJson\Feature\FeatureCollection', 'Dmandrade\GeoJson\GeoJson'));
    }
...
JSON;
        ...
        $this->assertInstanceOf('Dmandrade\GeoJson\Feature\FeatureCollection', $collection);
        $this->assertSame('FeatureCollection', $collection->getType());
