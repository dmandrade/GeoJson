...
namespace Dmandrade\GeoJson\Feature;

use Dmandrade\GeoJson\GeoJson;
use Dmandrade\GeoJson\Geometry\Geometry;
...
class Feature extends GeoJson
{
     ...
     * @param mixed $id
     * @param \Dmandrade\GeoJson\CoordinateReferenceSystem\CoordinateReferenceSystem|\Dmandrade\GeoJson\BoundingBox $arg,...
     */
